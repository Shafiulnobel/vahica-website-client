...
const MyOrder = () => {
    ...
    useEffect(()=>{
        fetch(`https://nameless-reaches-52059.herokuapp.com/orders?email=${user.email}`)
        .then(res=>res.json())
              ...
              <div className="col-md-8">
                ...
                <Col xs={6} md={4}>
                      ...
                      <Row className="py-3">
                          ...
                          <Col xs={6} md={6}>
                          <p className="card-text">status : <span className="text-warning fw-bold"> {order.status}</span></p>
                          </Col>
                      </Row>
              </div>
            </div>
