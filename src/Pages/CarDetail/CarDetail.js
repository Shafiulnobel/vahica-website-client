...
import banner from '../../images/banner_parchase.jpg'
...
const CarDetail = () => {
    ...
    useEffect(()=>{
        fetch(`https://nameless-reaches-52059.herokuapp.com/cars/${id}`)
        .then(res=>res.json())
    ...
    const onSubmit = data => {
        console.log(data)
        axios.post('https://nameless-reaches-52059.herokuapp.com/orders',data)
        .then(res=>{
          console.log(res)
...
<form  onSubmit={handleSubmit(onSubmit)}>
  <Row className="mx-auto">
    ...
    <Col className="text-start" xs={12}md={12}>
    <input className="btn btn-warning" type="submit" value="order"/>
    </Col>
  </Row>
